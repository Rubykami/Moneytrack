...
const Select: React.ForwardRefRenderFunction< HTMLSelectElement, SelectType> = ({name, onChange, value, selectinfo, optionA, optionB, optionC=''}) => {
    return (
    <div className='select__accounttype__div'>
        ...
        <select className='select__accounttype__div__select' name={name} value={value} onChange={onChange}>
